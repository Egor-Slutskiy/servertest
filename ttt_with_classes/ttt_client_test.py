...
cells = [(200, 100), (300, 100), (400, 100), (200, 200), (300, 200), (400, 200), (200, 300), (300, 300), (400, 300)]
current_move = 1
your_move = 3
game_ended = False
labels = []
...
def restart(isServer):
    ...
    current_move = 1
    for i in range(9):
        buttons[i].place(x=cells[i][0], y=cells[i][1], height=100, width=100)
    for i in labels:
        i.place_forget()
...
def draw_x(number):
    ...
    labels[-1].place(x=cells[number][0], y=cells[number][1], width=100, height=100)
